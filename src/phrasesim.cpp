...
phrasesim_t::phrasesim_t() {}

phrasesim_t::phrasesim_t(phrasesim_options opt) {
...
phrasesim_t::phrasesim_t(phrasesim_t& rhs) {
...
double phrasesim_t::get_lexweight(std::vector<std::string>& tokens, int mode) {
   double result = 0.0;
...
std::pair<double, double> phrasesim_t::operator()(std::vector<std::string> s1tokens,
...
std::pair<double, double> phrasesim_t::ngram(std::vector<std::string>& s1tokens,
                                 std::vector<std::string>& hyptokens, int mode) {
...
double phrasesim_t::ngramlw(std::vector<std::string>& tokens, int mode) {
   double result = 0.0;
   for (auto it = tokens.begin(); it != tokens.end(); it++) {
      if (mode == yisi::REF_MODE) {
...
std::pair<double, double> phrasesim_t::nwpr(std::vector<std::string>& s1tokens,
                                 std::vector<std::string>& hyptokens, int mode) {
...
double phrasesim_t::exact(std::vector<std::string>& reftokens, std::vector<std::string>& hyptokens) {
...
double phrasesim_t::mean(std::vector<std::string>& reftokens, std::vector<std::string>& hyptokens) {
